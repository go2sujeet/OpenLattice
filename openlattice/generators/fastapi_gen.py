...
def _generate_route(api: ApiDef, entities: list[EntityDef]) -> list[str]:
    ...
    # Determine response_model decorator kwarg
    response_model_part = ""
    if api.output_entity:
        response_model_part = f", response_model={api.output_entity}"
    ...
    return_type = api.output_entity if api.output_entity else "None"
